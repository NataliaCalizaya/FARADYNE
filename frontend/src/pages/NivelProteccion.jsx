  ...
  return (
    <div className="max-w-5xl mx-auto space-y-4">
      ...
      <div className="p-3 bg-blue-50 border border-blue-200 text-brand-blue rounded-md flex items-center gap-2 text-xs">
        ...
        <div>
          <strong>Paso 4 de 7 (HU04):</strong> Evaluación de riesgo según Norma IEC 62305 / IRAM 2184 para definir el Nivel de Protección (I a IV) y radio de esfera rodante.
        </div>
      </div>
